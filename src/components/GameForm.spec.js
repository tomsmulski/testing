...
describe("GameForm", () => {
  it.skip("renders two input fields and a button", () => {
    render(<GameForm />);
  ...
  it.skip('renders a form with the name "Create a new game"', () => {
    render(<GameForm />);
  ...
  it.skip("submits form data when every field is filled out", () => {
  ...
  it.skip("does not submit form if one input field is left empty", () => {
    const handleCreate = jest.fn();
    render(<GameForm onCreateGame={handleCreate} />);
